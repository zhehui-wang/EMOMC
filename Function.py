...
parser.add_argument('--network_type', type = int, default=0,  help='0 for LeNet5, 1 for Mobilenet, 2 for VGG16, 3 for ResNet, 4 for customized model')
...
parser.add_argument('--size_constraint', type = int, default=10000,  help='up bound for size')
parser.add_argument('--energy_constraint', type = int, default=10000,  help='up bound for energy')
