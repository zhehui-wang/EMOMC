...
You need to pre-train and pre-prune the model before optimziation. As the cluster of checkpoints is in large volumn, we do not provide checkpoints. Please run the following command to generated trained models.
